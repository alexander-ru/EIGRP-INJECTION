...
bg_image = PhotoImage(file="C:\Python\EIGRP\start_frame.png")
bg_image2 = PhotoImage(file="C:\Python\EIGRP\parameters_frame.png")
bg_image3 = PhotoImage(file="C:\Python\EIGRP\inject_frame.png")
bg_image4 = PhotoImage(file="C:\Python\EIGRP\success_frame.png")
        ...
        def exchange_successfully(packet):
            ...
            if packet.haslayer(EIGRP) and packet[EIGRP].opcode == 1:
                if packet.haslayer(EIGRPIntRoute):
                    if packet[EIGRPIntRoute].dst == internal_net_1 or packet[EIGRPIntRoute].dst == internal_net_2 or packet[EIGRPIntRoute].dst == internal_net_3 or packet[EIGRPExtRoute].dst == external_net_1 or packet[EIGRPExtRoute].dst == external_net_2 or packet[EIGRPExtRoute].dst == external_net_3:
...
button_image_1 = PhotoImage(file="C:\Python\EIGRP\Run_button.png")
button_image = PhotoImage(file="C:\Python\EIGRP\Scan_button.png")
